		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-md-3 col-lg-2 bg-light shadow-sm p-0">
					<div class="d-flex flex-column h-100 p-3 mt-3">
						...
						<ul class="nav nav-pills flex-column gap-2">
							...
							<div
								class="sidebar-heading ps-2 py-1 text-uppercase fw-medium fs-6 text-muted"
							>
								Admin
							</div>
							<!-- <li class="nav-item">
				...
				<div class="col-md-9 col-lg-10 ms-auto">
					...
					>
						<div
							class="container1 flex-grow-1 bg-body"
							style="width: 60%; gap: 1rem; height: 80vh; overflow-y: scroll"
						>
							<?php if($halaman) {
